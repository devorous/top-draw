 ...
 */
export function blurImageDataWithBackground(imageData, width, height, blurRadius, backgroundColor) {
 ...
 * @returns {ImageData} - Blurred image data
 */
export function blurImageData(imageData, width, height, blurRadius) {
  if (blurRadius <= 0) return imageData;
